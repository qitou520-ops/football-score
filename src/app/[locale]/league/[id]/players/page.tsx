...
import { getLeagueById, getLeagueTopScorersList } from "@/lib/data";
import { LeaguePageHeader } from "@/components/league/league-page-header";
import { LeagueTopScorers } from "@/components/league/league-top-scorers";
...
export async function generateMetadata({ params }: Props) {
  ...
  const t = await getTranslations("leaguePlayers");
...
export default async function LeaguePlayersPage({ params }: Props) {
  ...
  const scorers = await getLeagueTopScorersList(leagueId);
